!function() {
    ...
    CrudRequest = module.exports = new Class({
        ...
        // tell the outside that we're a crud message
        , isCRUDMessage: {value: true}
        ...
        // temporary storage which is not serialized
        , temp: {
            get: function() {
            ...
            , set: function(newValue) {
                if (!type.null(newValue) && !type.object(newValue)) throw new Error('The temp storage must be an object or null!');
                this._temp = newValue;
            }
        }
         ...
         * for each submessage
         *
         * @param <string> optional subselected entity to return
         * 
        ...
        , getMessageForSubSelected: function(filter) {
            ...
            // first we need to get an object of subselected items
        ...
        /**
         * send the message using the messageEmitter passed to it
         * 
         * @param <Object> with an emitMessage method
         * @param <Function> optional callback. if no callbacked
         *                   is passed to this method a promis will 
         *                   be returned
         */
        , send: function(messageEmitter, callback) {
            if (!messageEmitter || !type.function(messageEmitter.emitMessage)) throw new Error('Cannot send message when no message emitter is passed to the send function!');

            // store promise or callback
