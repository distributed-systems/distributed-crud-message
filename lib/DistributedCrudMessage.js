!function() {
    ...
    var   Class                 = require('ee-class')
        ...
        , log                   = require('ee-log')
        , clone                 = require('clone')
        , CrudFilter            = require('./DistributedCrudFilter')
        , DistributedMessage    = require('../../distributed-message');


    var   DistributedCrudMessage
        , ClassDefinition
        , ACTIONS;
    ...
    // actions avialabel on the crud message
    ACTIONS = {   
          list      : true
        , create    : true
        , update    : true
    ...
    // Apply actions to the class
    Object.keys(ACTIONS).forEach(function(actionName) {
        ClassDefinition[actionName.toUpperCase()] = actionName;
    });
    ...
    // create class
    DistributedCrudMessage = new Class(ClassDefinition);
    ...
    Object.keys(ACTIONS).forEach(function(actionName) {
        DistributedCrudMessage[actionName.toUpperCase()] = actionName;
    });

    // expose filter methods
    DistributedCrudMessage.filters = new CrudFilter();
    ...
    // export
    module.exports = DistributedCrudMessage;
}();
